...
public class Xemchitietnhap extends JFrame {
...
//	}
	 ...
	 * Create the frame.
	 */
	public Xemchitietnhap(String maphieun,String tennhann,String cungcap,String ngayn) {
		this.ctpn=PhieuNhapDao.getInstance().laydulieutuphieu(maphieun);
		this.tennv=tennhann;
		this.tennhacc=cungcap;
		this.nc1=nhacungcapDao.getInstance().chon1nhacc(tennhacc);
...
//		setBounds(100, 100, 1115, 546);
		...
		JLabel lblNewLabel_3 = new JLabel("PHIẾU NHẬP HÀNG");
		...
		JLabel lblNewLabel_4 = new JLabel("Tên nhà cung cấp: "+nc1.getTenNhaCungCap());
		lblNewLabel_4.setFont(new Font("Tahoma", Font.PLAIN, 20));
//		lblNewLabel_4.setText(nc1.getTenNhaCungCap());
		panel_4.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("Mã nhà cung cấp: "+nc1.getMaNhaCungCap());
		...
		JLabel lblNewLabel_10 = new JLabel("Đại diện nhà cung cấp");
		...
		JLabel lblNewLabel_113 = new JLabel(""+tennhacc);
