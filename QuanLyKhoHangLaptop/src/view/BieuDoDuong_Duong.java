...
public class BieuDoDuong_Duong extends JPanel {
	...
	public JFreeChart createChart(DefaultCategoryDataset dataset1, DefaultCategoryDataset dataset2) {
		...
		// màu đỏ cho đường biểu đồ tổng số lượng
		LineAndShapeRenderer renderer1 = new LineAndShapeRenderer();
		renderer1.setSeriesPaint(0, Color.BLUE);
		
		// Màu xanh cho đường biểu đồ giá trị
		...
		plot.setRenderer(0, renderer1); // Ánh xạ renderer2 với đường biểu đồ tổng số lượng
	...
	public static DefaultCategoryDataset setData(String CongViec, String type, String loai, ArrayList<String> day,
