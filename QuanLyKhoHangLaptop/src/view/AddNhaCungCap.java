			...
			contentPane.add(tx3);
				 ...
				 btn_them.addMouseListener(new MouseAdapter() {
					 	...
					 	public void mouseClicked(MouseEvent e) {
					 		if(tx1.getText().length()<=0 || tx2.getText()=="" || tx3.getText()=="" || tx4.getText()=="" || tx5.getText()=="") {
					 	    	JOptionPane.showConfirmDialog(null, " Dữ liệu bạn nhập vào đang bị thiếu. Mời bạn nhập lại","hi",JOptionPane.CLOSED_OPTION);	
					 		}
					 		else {
