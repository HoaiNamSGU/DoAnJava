...
//	ArrayList<NhaCungCap> dsnhacungcap=nhacungcapDao.getInstance().selectAll();
	...
	public XuatHang() {
		...
		ImageIcon icon_sanpham = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\product.png");
		...
		ImageIcon icon_nhaCungCap = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\supplier.png");
		...
		ImageIcon icon_nhaphang = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\nhaphang.png");
		...
		ImageIcon icon_phieunhap = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\phieuxuat.png");
		...
		ImageIcon icon_xuathang = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\xuathang.png");
		...
		ImageIcon icon_phieuxuat = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\phieuxuat.png");
		...
		ImageIcon icon_cuahang = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\store.png");
		...
		ImageIcon icon_taikhoan = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\taikhoan.png");
		...
		ImageIcon icon_thongke = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\thongke.png");
		...
		ImageIcon icon_doithongtin = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\thongtin.png");
		...
		ImageIcon icon_dangxuat = new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\dangxuat.png");
		...
		Object data [][]= {};
		 ...
		 scrollPane.setBounds(20, 145, 542, 489);
		...
		Object data1 [][]= {};
		 ...
		 scrollPane1.setBounds(650, 150, 564, 420);
		...
		ImageIcon icon_them =  new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\plus.png");
		...
		ImageIcon icon_suasoluong =  new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\pencil.png");
		...
		ImageIcon icon_xoasp =  new ImageIcon("D:\\LUYENTAPJAVA\\DoAnJava-main\\QuanLyKhoHangLaptop\\src\\img\\remove.png");
		...
		Controllerxuathang.ActionListener(btn_them,this);
		Controllerxuathang.ActionListener(btn_xoasp, this);
		Controllerxuathang.addKeyListener(jtext_tim, this);
		Controllerxuathang.ActionListener(btn_lammoi, this);
		Controllerxuathang.ActionListener(btn_nhaphang, this);
		Controllerxuathang.ActionListener(btn_suasoluong, this);

	}
	
	public void themhang() {
			if(txt_soluong.getText().equals(0)) JOptionPane.showMessageDialog(null, "Bạn chưa nhập số lượng cần XUẤT");
			else {
				sohang++;
...
//			 LaptopDAO.getintance().update1dulieuu(mm, Long.parseLong(soluong));
...
//				 }
	...
	public void suasl() {
	  	 ...
	  	 String g=JOptionPane.showInputDialog("Bạn muốn sửa xuất bao nhiêu hàng");
