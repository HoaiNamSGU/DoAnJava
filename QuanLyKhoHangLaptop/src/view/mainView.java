...
public class mainView extends JFrame {
	...
	public String column[] = { "Id", "Tên laptop", "Số lượng", "Giá", "CPU", "Ram", "Bộ nhớ", "Hệ điều hành" };
	public mainView() {
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{lt.getMaLaptop(),lt.getTenLaptop(),lt.getSoLuong(),lt.getGia(),lt.getCPU(),lt.getRam(),lt.getRom(),lt.getHeDieuHanh()}
			},
			new String[] {
